    ...
    <SafeAreaView style={[styles.fundo]}>
      ...
      <View style={styles.CardOpç}>
        ...
        >
          ...
          <Text style={[styles.txtop, { marginLeft: width / 30 }]}>Solicitação/Andamento</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.opç} onPress={alertar}>
          ...
          <Text style={[styles.txtop, { marginLeft: width / 30 }]}>Perfil Profissional</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.opç} onPress={alertar}>
          <Ionicons name="location" size={28} color="#454A4D" />
          <Text style={[styles.txtop, { marginLeft: width / 30 }]}>Cadastrar Produtos</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.opç} onPress={alertar}>
          <Ionicons name="construct" size={28} color="#454A4D" />
          <Text style={[styles.txtop, { marginLeft: width / 30 }]}>Configuração</Text>
        </TouchableOpacity>
