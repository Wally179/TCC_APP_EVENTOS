...
import { Text, Image, TouchableOpacity, SafeAreaView, View,ScrollView, FlatList,Dimensions } from 'react-native';
import {useNavigation} from '@react-navigation/native';
import styles from "./style";
import { Ionicons } from '@expo/vector-icons';
import MapView, {Marker, Callout} from 'react-native-maps';
import FornProduto from '../../../components/FornProduto';
import AceitarBtn from '../../../components/Aceitar';




export default function AceitarDetalhes() {
  ...
  return (
    <SafeAreaView style={styles.fundo}>
      ...
      <View style={styles.container}>   
          ...
          ListHeaderComponent={
                                ...
                                <View style={styles.linhaP}>
                                  <View style={styles.bloco}><Text>Qnd</Text></View>
                                  <View style={styles.bloco2}><Text>Produto</Text></View>
                                  <View style={styles.bloco3}><Text>Preço</Text></View>
                                </View>
                              </View>
      ...
      <AceitarBtn style={{bottom:height*0.22, left:width*0.9,}}/>
      </View>
