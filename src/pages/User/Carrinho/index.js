  ...
  return (
    ...
    <View style={styles.superior}>
      <View style={styles.linha1}>
        <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('Catalogo',{IDforn})}><Ionicons name="arrow-back-outline" size={35} color="grey" /></TouchableOpacity>
    ...
    <FlatList
          style={styles.flat}
          ListHeaderComponent={<Text style={styles.serviço}>Suas escolhas</Text>}
